...
```{r example-process-assess, fig.height=3, fig.cap="Results from a grid search for a k-nearest neighbor model on the Ames housing data assessing values for _k_ ranging from 2-25."}
# print model results
knn_fit
