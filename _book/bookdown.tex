...
\CommentTok{##               rowname freqRatio percentUnique zeroVar  nzv}
\CommentTok{## 1              Street    255.75       0.09737   FALSE TRUE}
\CommentTok{## 2               Alley     24.69       0.14606   FALSE TRUE}
\CommentTok{## 3        Land_Contour     21.88       0.19474   FALSE TRUE}
\CommentTok{## 4           Utilities   2052.00       0.14606   FALSE TRUE}
\CommentTok{## 5          Land_Slope     21.68       0.14606   FALSE TRUE}
\CommentTok{## 6         Condition_2    184.73       0.34080   FALSE TRUE}
\CommentTok{## 7           Roof_Matl    112.50       0.29211   FALSE TRUE}
\CommentTok{## 8           Bsmt_Cond     24.03       0.29211   FALSE TRUE}
\CommentTok{## 9      BsmtFin_Type_2     23.13       0.34080   FALSE TRUE}
\CommentTok{## 10            Heating     91.82       0.29211   FALSE TRUE}
\CommentTok{## 11    Low_Qual_Fin_SF    674.33       1.41188   FALSE TRUE}
\CommentTok{## 12      Kitchen_AbvGr     22.85       0.19474   FALSE TRUE}
\CommentTok{## 13         Functional     35.30       0.38948   FALSE TRUE}
\CommentTok{## 14     Enclosed_Porch    109.06       7.20545   FALSE TRUE}
\CommentTok{## 15 Three_season_porch    674.67       1.26582   FALSE TRUE}
\CommentTok{## 16       Screen_Porch    186.90       4.81986   FALSE TRUE}
\CommentTok{## 17          Pool_Area   2046.00       0.43817   FALSE TRUE}
\CommentTok{## 18            Pool_QC    682.00       0.24343   FALSE TRUE}
\CommentTok{## 19       Misc_Feature     29.58       0.29211   FALSE TRUE}
\CommentTok{## 20           Misc_Val    124.00       1.26582   FALSE TRUE}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## }
\CommentTok{## Box-Cox transformation on all_outcomes()}
\CommentTok{## Centering for all_numeric(), -all_outcomes()}
\CommentTok{## Scaling for all_numeric(), -all_outcomes()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##    Overall_Qual Exter_Qual Bsmt_Qual Low_Qual_Fin_SF Kitchen_Qual}
\CommentTok{##    <fct>        <fct>      <fct>               <int> <fct>       }
\CommentTok{##  1 Above_Avera~ Typical    Typical                 0 Typical     }
\CommentTok{##  2 Average      Typical    Typical                 0 Typical     }
\CommentTok{##  3 Above_Avera~ Typical    Typical                 0 Good        }
\CommentTok{##  4 Good         Good       Typical                 0 Excellent   }
\CommentTok{##  5 Above_Avera~ Typical    Typical                 0 Good        }
\CommentTok{##  6 Very_Good    Good       Good                    0 Good        }
\CommentTok{##  7 Very_Good    Good       Good                    0 Good        }
\CommentTok{##  8 Good         Typical    Typical                 0 Good        }
\CommentTok{##  9 Above_Avera~ Typical    Good                    0 Typical     }
\CommentTok{## 10 Above_Avera~ Typical    Good                    0 Typical     }
\CommentTok{## # ... with 2,044 more rows, and 1 more variable: Garage_Qual <fct>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## Centering for all_numeric(), -all_outcomes()}
\CommentTok{## Scaling for all_numeric(), -all_outcomes()}
\CommentTok{## PCA extraction with all_numeric(), -all_outcomes()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##          Min. 1st Qu. Median   Mean 3rd Qu.   Max. NA's}
\CommentTok{## model1 0.8350  0.8350 0.8365 0.8388  0.8431 0.8447    0}
\CommentTok{## model2 0.8350  0.8350 0.8365 0.8388  0.8431 0.8447    0}
\CommentTok{## model3 0.8365  0.8495 0.8792 0.8758  0.8908 0.9314    0}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  )))}\OperatorTok{$}\NormalTok{statistics}\OperatorTok{$}\NormalTok{Accuracy}
\CommentTok{##                   Min. 1st Qu. Median   Mean 3rd Qu.   Max. NA's}
\CommentTok{## logistic_model  0.8365  0.8495 0.8792 0.8758  0.8908 0.9314    0}
\CommentTok{## penalized_model 0.8447  0.8759 0.8835 0.8836  0.8915 0.9412    0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  2 h(Year_Remod_Add-2007) * h(Total_Bsmt_SF-1136)                   8.93e+0}
\CommentTok{##  3 h(2007-Year_Remod_Add) * h(Total_Bsmt_SF-1136)                  -1.22e+0}
\CommentTok{##  4 NeighborhoodEdwards * h(Year_Built-2002) * h(Gr_Liv_Area-2~     -6.71e+1}
\CommentTok{##  5 h(Lot_Area-3874) * h(3-Garage_Cars)                             -1.17e+0}
\CommentTok{##  6 Bsmt_ExposureGd * h(Total_Bsmt_SF-1136)                          3.12e+1}
\CommentTok{##  7 NeighborhoodCrawford * h(2002-Year_Built)                        4.25e+2}
\CommentTok{##  8 h(2002-Year_Built) * h(Year_Remod_Add-1974)                      7.90e+0}
\CommentTok{##  9 h(2002-Year_Built) * h(1974-Year_Remod_Add)                      5.42e+0}
\CommentTok{## 10 h(Kitchen_AbvGr-1) * FunctionalTyp                              -1.55e+4}
\CommentTok{## 11 Overall_QualVery_Excellent * FunctionalTyp                       9.68e+4}
...
\CommentTok{## 15 h(Total_Bsmt_SF-1136) * h(115-Screen_Porch)                     -3.04e-1}
\CommentTok{## 16 h(Lot_Area-3874) * h(Gr_Liv_Area-2411) * h(3-Garage_Cars)       -2.99e-3}
\CommentTok{## 17 h(Lot_Area-3874) * h(2411-Gr_Liv_Area) * h(3-Garage_Cars)        5.29e-4}
\CommentTok{## 18 Overall_CondGood * h(2002-Year_Built)                            3.33e+2}
\CommentTok{## 19 Overall_CondVery_Good * h(2002-Year_Built)                       3.68e+2}
\CommentTok{## 20 Overall_CondAbove_Average * h(2790-Gr_Liv_Area)                  6.20e+0}
\end{Highlighting}
\end{Shaded}
...
\emph{K}-nearest neighbor\index{k-nearest neighbor} (KNN) is a very simple algorithm in which each observation is predicted based on its ``similarity'' to other observations. Unlike most methods in this book, KNN is a \emph{memory-based} algorithm and cannot be summarized by a closed-form model. This means the training samples are required at run-time and predictions are made directly from the sample relationships. Consequently, KNNs are also known as \emph{lazy learners} \citep{cunningham2007k} and can be computationally inefficient. However, KNNs have been successful in a large number of business problems (see, for example, \citet{jiang2012improved} and \citet{mccord2011spam}) and are useful for pre-precessing purposes as well (as was discussed in Section \ref{impute}).
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# create training (70%) set for the rsample::attrition data.}
\NormalTok{attrit <-}\StringTok{ }\NormalTok{attrition }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate_if}\NormalTok{(is.ordered, factor, }\DataTypeTok{ordered =} \OtherTok{FALSE}\NormalTok{)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{churn_split <-}\StringTok{ }\KeywordTok{initial_split}\NormalTok{(attrit, }\DataTypeTok{prop =} \FloatTok{.7}\NormalTok{, }\DataTypeTok{strata =} \StringTok{"Attrition"}\NormalTok{)}
\NormalTok{churn_train <-}\StringTok{ }\KeywordTok{training}\NormalTok{(churn_split)}

\CommentTok{# import MNIST training data}
\NormalTok{mnist <-}\StringTok{ }\NormalTok{dslabs}\OperatorTok{::}\KeywordTok{read_mnist}\NormalTok{()}
\KeywordTok{names}\NormalTok{(mnist)}
\CommentTok{## [1] "train" "test"}
\end{Highlighting}
...
{\centering \includegraphics{bookdown_files/figure-latex/map-homes-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{two_houses <-}\StringTok{ }\NormalTok{ames_train }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Gr_Liv_Area, Year_Built) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{sample_n}\NormalTok{(}\DecValTok{2}\NormalTok{)}

\NormalTok{two_houses}
\CommentTok{## # A tibble: 2 x 2}
\CommentTok{##   Gr_Liv_Area Year_Built}
\CommentTok{##         <int>      <int>}
\CommentTok{## 1         896       1961}
\CommentTok{## 2        1511       2002}

\CommentTok{# Euclidean}
\KeywordTok{dist}\NormalTok{(two_houses, }\DataTypeTok{method =} \StringTok{"euclidean"}\NormalTok{)}
\CommentTok{##       1}
\CommentTok{## 2 616.4}

\CommentTok{# Manhattan}
\KeywordTok{dist}\NormalTok{(two_houses, }\DataTypeTok{method =} \StringTok{"manhattan"}\NormalTok{)}
\CommentTok{##     1}
\CommentTok{## 2 656}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{bookdown_files/figure-latex/difference-btwn-distance-measures-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# create blueprint}
\NormalTok{blueprint <-}\StringTok{ }\KeywordTok{recipe}\NormalTok{(Attrition }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{data =}\NormalTok{ churn_train) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_nzv}\NormalTok{(}\KeywordTok{all_nominal}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_integer}\NormalTok{(}\KeywordTok{contains}\NormalTok{(}\StringTok{"Satisfaction"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_integer}\NormalTok{(WorkLifeBalance) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_integer}\NormalTok{(JobInvolvement) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_dummy}\NormalTok{(}\KeywordTok{all_nominal}\NormalTok{(), }\OperatorTok{-}\KeywordTok{all_outcomes}\NormalTok{(), }\DataTypeTok{one_hot =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_center}\NormalTok{(}\KeywordTok{all_numeric}\NormalTok{(), }\OperatorTok{-}\KeywordTok{all_outcomes}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{step_scale}\NormalTok{(}\KeywordTok{all_numeric}\NormalTok{(), }\OperatorTok{-}\KeywordTok{all_outcomes}\NormalTok{())}
...
\CommentTok{# create a hyperparameter grid search}
\NormalTok{hyper_grid <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}\DataTypeTok{k =} \KeywordTok{floor}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(churn_train)}\OperatorTok{/}\DecValTok{3}\NormalTok{, }
                                        \DataTypeTok{length.out =} \DecValTok{20}\NormalTok{)))}

\CommentTok{# fit knn model and perform grid search}
\NormalTok{knn_grid <-}\StringTok{ }\KeywordTok{train}\NormalTok{(}
\NormalTok{  blueprint, }
  \DataTypeTok{data =}\NormalTok{ churn_train, }
  \DataTypeTok{method =} \StringTok{"knn"}\NormalTok{, }
  \DataTypeTok{trControl =}\NormalTok{ cv, }
  \DataTypeTok{tuneGrid =}\NormalTok{ hyper_grid,}
  \DataTypeTok{metric =} \StringTok{"ROC"}
\NormalTok{  )}

\KeywordTok{ggplot}\NormalTok{(knn_grid)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics{bookdown_files/figure-latex/range-k-values-1} 
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{index <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(mnist}\OperatorTok{$}\NormalTok{train}\OperatorTok{$}\NormalTok{images), }\DataTypeTok{size =} \DecValTok{10000}\NormalTok{)}
\NormalTok{mnist_x <-}\StringTok{ }\NormalTok{mnist}\OperatorTok{$}\NormalTok{train}\OperatorTok{$}\NormalTok{images[index, ]}
\NormalTok{mnist_y <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(mnist}\OperatorTok{$}\NormalTok{train}\OperatorTok{$}\NormalTok{labels[index])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mnist_x }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{as.data.frame}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{map_df}\NormalTok{(sd) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(feature, sd) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(sd)) }\OperatorTok{+}
...
{\centering \includegraphics{bookdown_files/figure-latex/mnist-plot-variance-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/mnist-plot-nzv-feature-image-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/mnist-initial-model-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# create confusion matrix and just look at sensitivity, specificity, & accuracy}
\NormalTok{cm <-}\StringTok{ }\KeywordTok{confusionMatrix}\NormalTok{(knn_mnist}\OperatorTok{$}\NormalTok{pred}\OperatorTok{$}\NormalTok{pred, knn_mnist}\OperatorTok{$}\NormalTok{pred}\OperatorTok{$}\NormalTok{obs)}
\NormalTok{cm}\OperatorTok{$}\NormalTok{byClass[, }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{, }\DecValTok{11}\NormalTok{)]}
\CommentTok{##          Sensitivity Specificity Balanced Accuracy}
\CommentTok{## Class: 0      0.9642      0.9962            0.9802}
\CommentTok{## Class: 1      0.9917      0.9841            0.9879}
\CommentTok{## Class: 2      0.9156      0.9955            0.9555}
\CommentTok{## Class: 3      0.9164      0.9920            0.9542}
\CommentTok{## Class: 4      0.8699      0.9961            0.9330}
\CommentTok{## Class: 5      0.9151      0.9915            0.9533}
\CommentTok{## Class: 6      0.9795      0.9889            0.9842}
\CommentTok{## Class: 7      0.9327      0.9897            0.9612}
\CommentTok{## Class: 8      0.8224      0.9979            0.9102}
\CommentTok{## Class: 9      0.9330      0.9853            0.9591}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# get median value for feature importance}
\NormalTok{imp <-}\StringTok{ }\NormalTok{vi}\OperatorTok{$}\NormalTok{importance }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rownames_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"feature"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(response, imp, }\OperatorTok{-}\NormalTok{feature) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(feature) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{imp =} \KeywordTok{median}\NormalTok{(imp))}

\CommentTok{# create tibble for all edge pixels}
\NormalTok{edges <-}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
  \DataTypeTok{feature =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"V"}\NormalTok{, nzv),}
  \DataTypeTok{imp =} \DecValTok{0}
\NormalTok{)}

\CommentTok{# combine and plot}
\NormalTok{imp <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(imp, edges) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ID  =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{str_extract}\NormalTok{(feature, }\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{d+"}\NormalTok{))) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(ID)}
\KeywordTok{image}\NormalTok{(}\KeywordTok{matrix}\NormalTok{(imp}\OperatorTok{$}\NormalTok{imp, }\DecValTok{28}\NormalTok{, }\DecValTok{28}\NormalTok{), }\DataTypeTok{col =} \KeywordTok{gray}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{0.05}\NormalTok{)), }
...
{\centering \includegraphics{bookdown_files/figure-latex/plot-mnist-vi-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# get a few accurate predictions}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{9}\NormalTok{)}
\NormalTok{good <-}\StringTok{ }\NormalTok{knn_mnist}\OperatorTok{$}\NormalTok{pred }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(pred }\OperatorTok{==}\StringTok{ }\NormalTok{obs) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{sample_n}\NormalTok{(}\DecValTok{4}\NormalTok{)}

\CommentTok{# get a few inaccurate predictions}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{9}\NormalTok{)}
\NormalTok{bad <-}\StringTok{ }\NormalTok{knn_mnist}\OperatorTok{$}\NormalTok{pred }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(pred }\OperatorTok{!=}\StringTok{ }\NormalTok{obs) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{sample_n}\NormalTok{(}\DecValTok{4}\NormalTok{)}

\NormalTok{combine <-}\StringTok{ }\KeywordTok{bind_rows}\NormalTok{(good, bad)}

\CommentTok{# get original feature set with all pixel features}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{index <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(mnist}\OperatorTok{$}\NormalTok{train}\OperatorTok{$}\NormalTok{images), }\DecValTok{10000}\NormalTok{)}
\NormalTok{X <-}\StringTok{ }\NormalTok{mnist}\OperatorTok{$}\NormalTok{train}\OperatorTok{$}\NormalTok{images[index,]}
...
{\centering \includegraphics{bookdown_files/figure-latex/correct-vs-incorrect-1} 
...
\emph{Tree-based models}\index{tree-based models} are a class of nonparametric algorithms that work by partitioning the feature space into a number of smaller (non-overlapping) regions with similar response values using a set of \emph{splitting rules}\index{splitting rules}. Predictions are obtained by fitting a simpler model (e.g., a constant like the average response value) in each region. Such \emph{divide-and-conquor} methods can produce simple rules that are easy to interpret and visualize with \emph{tree diagrams}\index{tree diagrams}. As we'll see, decision trees offer many benefits; however, they typically lack in predictive performance compared to more complex algorithms like neural networks and MARS. However, future chapters will discuss powerful ensemble algorithms---like random forests and gradient boosting machines---which are constructed by combining togther many decision trees in a clever way. This chapter will provide you with a strong foundation in decision trees.
...
We refer to the first subgroup at the top of the tree as the \emph{root node}\index{root node} (this node contains all of the training data). The final subgroups at the bottom of the tree are called the \emph{terminal nodes}\index{terminal nodes} or \emph{leaves}\index{leaves}. Every subgroup inbetween is refrred to as an internal node. The connection between nodes are called \emph{branches}\index{branches}.
...
{\centering \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/decision-stump-1} \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/decision-stump-2} 
...
{\centering \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/depth-3-decision-tree-1} \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/depth-3-decision-tree-2} 
...
{\centering \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/iris-decision-tree-1} \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/iris-decision-tree-2} 
...
{\centering \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/deep-overfit-tree-1} \includegraphics[width=0.48\linewidth]{bookdown_files/figure-latex/deep-overfit-tree-2} 
...
{\centering \includegraphics{bookdown_files/figure-latex/dt-early-stopping-1} 
...
An alternative to explicitly specifying the depth of a decision tree is to grow a very large, complex tree and then \emph{prune}\index{prune} it back to find an optimal subtree. We find the optimal subtree by using a \emph{cost complexity parameter}\index{cost complexity parameter} (\(\alpha\)) that penalizes our objective function in \eqref{eq:partobjective} for the number of terminal nodes of the tree (\(T\)) as in \eqref{eq:prune}.
...
{\centering \includegraphics{bookdown_files/figure-latex/pruned-tree-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/basic-ames-tree-plot-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/plot-cp-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/no-cp-tree-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# rpart cross validation results}
\NormalTok{ames_dt1}\OperatorTok{$}\NormalTok{cptable}
\CommentTok{##         CP nsplit rel error xerror    xstd}
\CommentTok{## 1  0.47941      0    1.0000 1.0015 0.06120}
\CommentTok{## 2  0.11290      1    0.5206 0.5226 0.03200}
\CommentTok{## 3  0.06999      2    0.4077 0.4099 0.03112}
\CommentTok{## 4  0.02759      3    0.3377 0.3573 0.02223}
\CommentTok{## 5  0.02347      4    0.3101 0.3340 0.02184}
\CommentTok{## 6  0.02201      5    0.2866 0.3302 0.02446}
\CommentTok{## 7  0.02039      6    0.2646 0.3245 0.02422}
\CommentTok{## 8  0.01190      7    0.2442 0.3062 0.02642}
\CommentTok{## 9  0.01116      8    0.2323 0.3026 0.02709}
\CommentTok{## 10 0.01104      9    0.2212 0.2972 0.02705}
\CommentTok{## 11 0.01000     10    0.2101 0.2920 0.02705}

\CommentTok{# caret cross validation results}
\NormalTok{ames_dt3 <-}\StringTok{ }\KeywordTok{train}\NormalTok{(}
\NormalTok{  Sale_Price }\OperatorTok{~}\StringTok{ }\NormalTok{.,}
  \DataTypeTok{data =}\NormalTok{ ames_train,}
...
\KeywordTok{ggplot}\NormalTok{(ames_dt3)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics{bookdown_files/figure-latex/cp-table-1} 
...
{\centering \includegraphics{bookdown_files/figure-latex/dt-vip-1} 
...
\begin{Highlighting}[]
\CommentTok{# Construct partial dependence plots}
\NormalTok{p1 <-}\StringTok{ }\KeywordTok{partial}\NormalTok{(ames_dt3, }\DataTypeTok{pred.var =} \StringTok{"Gr_Liv_Area"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{autoplot}\NormalTok{()}
\NormalTok{p2 <-}\StringTok{ }\KeywordTok{partial}\NormalTok{(ames_dt3, }\DataTypeTok{pred.var =} \StringTok{"Year_Built"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{autoplot}\NormalTok{()}
\NormalTok{p3 <-}\StringTok{ }\KeywordTok{partial}\NormalTok{(ames_dt3, }\DataTypeTok{pred.var =} \KeywordTok{c}\NormalTok{(}\StringTok{"Gr_Liv_Area"}\NormalTok{, }\StringTok{"Year_Built"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{plotPartial}\NormalTok{(}\DataTypeTok{levelplot =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{zlab =} \StringTok{"yhat"}\NormalTok{, }\DataTypeTok{drape =} \OtherTok{TRUE}\NormalTok{, }
              \DataTypeTok{colorkey =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{screen =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{z =} \DecValTok{-20}\NormalTok{, }\DataTypeTok{x =} \DecValTok{-60}\NormalTok{))}
...
{\centering \includegraphics{bookdown_files/figure-latex/dt-pdp-1} 
